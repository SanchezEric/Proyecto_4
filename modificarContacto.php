	...
	<section id="contenidomapa">
		<article>
			...
			<article id = "letrasregistro">			
				<form name="formInserContacto" action="modificarContacto.proc.php" method="get">
					<input type="hidden" name="idContacto" value="<?php echo $prod['id_contacto']; ?>">
					
					<strong>Nombre:</strong><br/>
					<input type="text" name="nomCont" size="20" maxlength="25" value="<?php echo utf8_encode("$prod[nombre_contacto]"); ?>"required/><br/><br/>

					<strong>Apellido:</strong><br/>
					<input type="text" name="apellCont" size="20" maxlength="25" value="<?php echo utf8_encode("$prod[apellidos_contacto]"); ?>"required/><br/><br/>
					...
					<input class="myButton1" id="botonFormModContacto" type="submit" value="Modifica el contacto">
