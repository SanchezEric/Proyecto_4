<?php
	session_start();
		...
		$sql = "UPDATE usuario SET usuario.nombre_usuario='$_REQUEST[nomUsuario]', usuario.apellidos_usuario='$_REQUEST[apellidoUsuario]', usuario.mail_usuario = '$_REQUEST[mailUsuario]', usuario.direccion_usuario= '$_REQUEST[direccionUsuario]', usuario.telefono_usuario= '$_REQUEST[telefonoUsuario]' WHERE usuario.id_usuario='$_REQUEST[idUsuario]'";
