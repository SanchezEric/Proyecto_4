		...
		<?php
			...
			<table>
				...
				while ($prod = mysqli_fetch_array($datos)){
					echo "<td>".$prod['nombre_usuario']."
					</td><td>".$prod['apellidos_usuario']."
					</td><td>".$prod['password']."
					</td><td>".$prod['mail_usuario']."
					</td><td>".$prod['direccion_usuario']."
					</td><td>".$prod['telefono_usuario']."
					<td>".$prod['nivel_usuario']."</td><td>";
